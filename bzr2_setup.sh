...
main() {
  ...
  mime_types_supported=(
    ...
    audio/x-ahx audio/x-aon audio/x-amf audio/x-cust audio/x-ddmf audio/x-deflemask audio/x-dsmi-amf
    ...
    audio/x-mpegurl audio/x-mptm audio/x-nds-strm audio/x-nds-strm-ffta2 audio/x-np audio/x-ntk audio/x-okt
