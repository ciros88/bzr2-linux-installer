...
main() {
  ...
  mime_types_supported=(
    ...
    audio/x-hip-mcmd audio/x-hip-st audio/x-hip-st-coso audio/x-implay audio/x-it audio/x-lds audio/x-m2 audio/x-mdx
    audio/x-minipsf audio/x-ml audio/x-mmdc audio/x-mo3 audio/x-mod audio/x-mpegurl audio/x-mptm audio/x-nds-strm
    audio/x-nds-strm-ffta2 audio/x-np audio/x-ntk audio/x-okt audio/x-prun audio/x-psf audio/x-psm audio/x-pt3
