...
main() {
  ...
  mime_types_supported=(
    ...
    audio/x-cust audio/x-ddmf audio/x-deflemask audio/x-dsmi-amf audio/x-dsmi-amf-compact audio/x-dw audio/x-dz
    audio/x-fc audio/x-fc-bsi audio/x-flac+ogg audio/x-fp audio/x-hip audio/x-hip-7v audio/x-hip-coso audio/x-hip-mcmd
    audio/x-hip-st audio/x-hip-st-coso audio/x-it audio/x-lds audio/x-m2 audio/x-mdx audio/x-minipsf audio/x-ml
