...
!system "./filetype_associations_component_util_generator.sh"

Section
!tempfile stdoutfile
!system 'printf "%x" $(date +%s) > "${stdoutfile}"'
...
!define URL_REPO "https://raw.githubusercontent.com/ciros88/bzr2-linux"
#TODO switch to main branch
!define URL_SETUP_MAIN "${URL_REPO}/feature/nsis/nsis"
...
!define URL_BINARY_ZIP_FALLBACK "${URL_REPO}/artifacts/binaries"
...
!system 'echo -n "${SETUP_LATEST_VERSION}" > ${SETUP_FILENAME_LATEST_VERSION}'
